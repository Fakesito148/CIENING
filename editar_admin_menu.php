...
<div class="container" style="flex-direction: column; align-items: center; margin-top: 50px;">
    <h1 style="color:#c00;">Lista de Administradores</h1>
                ...
                <?php while($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="eliminar_admin.php?id=<?= $row['id'] ?>" class="eliminar" onclick="return confirm('¿Seguro que deseas eliminar este administrador?');">Eliminar</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            <?php else: ?>
